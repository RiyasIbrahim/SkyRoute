...
def set_start_and_end(start_point, end_point):
    if start_point:
        ...
        You can enter 'o' for 'origin', 'd' for 'destination' \
        , or 'b' for 'both': ")
        if change_point == 'b':
...
def get_start():
    ...
    if landmark_choices[start_point_letter]:
        ...
        print("Sorry, that's not a landmark we have \
...
def show_landmarks():
    see_landmarks = input("Would you like to see the \
    list of landmarks again?\nEnter y/n: ")
    if see_landmarks == 'y':
